...
#define COLLECTIVE_Pin GPIO_PIN_4
#define COLLECTIVE_GPIO_Port GPIOA
#define SR_LATCH_Pin GPIO_PIN_0
#define SR_LATCH_GPIO_Port GPIOB
#define SR_CLOCK_Pin GPIO_PIN_1
#define SR_CLOCK_GPIO_Port GPIOB
#define SR_DATA_Pin GPIO_PIN_10
